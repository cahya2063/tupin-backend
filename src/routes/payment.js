...
import { checkBalance, createInvoice, createDisbursements, getInvoices, getDisbursements, getTransfer, getInvoicesByJobId } from '../controllers/payment.js'
...
paymentRouter.get('/:jobId/get-invoice-by-jobId', authRole(['client', 'technician']), getInvoicesByJobId)
